<template>
	...
	<span class="logo-mini">
		<a href="/"><img src="/static/img/copilot-logo-white.svg" alt="Logo"
                         class="img-responsive center-block logo"></a>
	</span>
            <!-- Header Navbar -->
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img  v-bind:src="user.avatar_image.url" class="user-image" alt="User Image">
        ...
        <sidebar :display-name="user.user_name" :picture-url="user.avatar_image.url"/>
