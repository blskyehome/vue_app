  ...
  <section class="content">
    ...
    <div class="row">
      <div class="alert alert-success alert-dismissible">
        ...
        <h4><i class="icon fa fa-check"></i> 欢迎使用!</h4>
        Click on icon to check it out on github. <a href="https://github.com/blskyehome/vue_app" target="_blank"><i class="fa fa-github fa-2x"></i></a>
      </div>
